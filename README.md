...
* it tests that output matches [a pattern](#pattern-matching) you provide (`_stdout="some string"`)
* it tests that stderr is either empty, or matches [a pattern](#pattern-matching) you provide (`_stderr=` or `_stderr="expected error message"`)
